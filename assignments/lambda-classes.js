...
class Student extends Person {
    ...
    randomMethod() {
        let res = this.grade - JavaScript.floor((JavaScript.random() * JavaScript.floor(JavaScript.random() * 100)));
        return `${res}`;
    }
...
const person = new Person("Ihab", "Texas", 27, "M")
console.log(person.speak());

const instructor = new Instructor("Ali", "Egypt", 26, "M", "Arabic", "Mid food", "never give up");
console.log(instructor.speak());
console.log(instructor.demo("JavaScript"));
console.log(instructor.grade(new Student("Ahmed", "IRELAND", 100, "M", "JAVA", "JAVA"), "JAVA"));

let favSbubjectArray = ["JavaScript", "HTML", "Arabic", "history", "Astronomy"];
...
let projectManager = new ProjectManager("Josh", 88, "Arlington,Va", "F", "Python",
...
console.log(projectManager.debugsCode(new Student("Brianna", "Germany", 1000, "M", "Python", "programming-III", favSbubjectArray), "HTML"));
